    ...
    <div className="min-h-screen bg-[#FAF7F2] text-[#1E293B] flex flex-col font-sans selection:bg-[#F26430] selection:text-white">
      ...
      <main className="flex-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
          ...
          {/* SECTION 1: 🔥 ชาเลนจ์ที่คุณกำลังเข้าร่วม (Active Joined Challenges) */}
          {isLoggedIn ? (
            <section className="space-y-6">
              ...
              {/* Vertical Full-width Quest Rows */}
            ...
            <div className="bg-[#1E293B] text-white rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden border border-slate-700 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="space-y-3 max-w-2xl text-center md:text-left">
                <div className="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-400 bg-emerald-950/80 px-3 py-1 rounded-full border border-emerald-500/30">
                  ...
                  <span>Guest Mode (ปลดล็อกระบบชาเลนจ์)</span>
                </div>
                <h3 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-white">
                  เข้าสู่ระบบเพื่อสะสม Badges & ติดตามความคืบหน้าชาเลนจ์!
                </h3>
                <p className="text-sm text-slate-300">
                  ปลดล็อกประสบการณ์ทำกิจกรรมยามว่างอย่างท้าทาย สะสมตรารางวัล และนำไปแลกสิทธิประโยชน์พิเศษ
                </p>
              </div>

              <button
                onClick={() => setIsLoggedIn(true)}
                className="bg-[#F26430] hover:bg-[#D95322] text-white px-8 py-3.5 rounded-full font-bold text-sm sm:text-base transition-all shadow-lg shadow-[#F26430]/30 shrink-0"
              >
                เข้าสู่ระบบเลย ➔
              </button>
            </div>
          ...
          {/* SECTION 2: 🎯 ชาเลนจ์แนะนำตามหมวดหมู่ที่คุณสนใจ (Recommended Challenges) */}
          <section className="space-y-6 pt-4">
            ...
            {/* Recommended Challenge Cards Grid */}
          ...
          {/* SECTION 3: 🏆 ตู้สะสม Badges & เกียรติยศ (Badges Collection Gallery) */}
