        ...
        <div className="p-6 space-y-4">
          ...
          {tab === 'signup' && (
            <Link
              href="/onboarding"
              onClick={onClose}
              className="w-full bg-gradient-to-r from-[#4A7C59] via-emerald-600 to-teal-600 hover:from-[#3B6347] hover:to-emerald-700 text-white p-3 rounded-2xl font-black text-xs sm:text-sm shadow-md flex items-center justify-between gap-2 active:scale-98 transition-all group"
            >
          ...
          {/* Social Auth Buttons (Meetup Style) */}
